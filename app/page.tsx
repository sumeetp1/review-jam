    ...
    <div className="min-h-screen flex flex-col bg-white dark:bg-[#09090b] relative overflow-x-hidden">
      ...
      <header className="flex items-center justify-between px-4 md:px-8 h-14 shrink-0 relative z-10 border-b border-slate-200 dark:border-white/[0.06]">
        ...
        <div className="flex items-center gap-3">
          <Link href="/feed" className="text-sm font-semibold text-slate-600 dark:text-zinc-300 hover:text-slate-900 dark:hover:text-zinc-100 transition hidden md:inline-block">
            Feed
          </Link>
          <Link href="/c" className="text-sm font-semibold text-slate-600 dark:text-zinc-300 hover:text-slate-900 dark:hover:text-zinc-100 transition hidden md:inline-block">
            Communities
          </Link>
          <Link href="/explore" className="text-sm font-semibold text-slate-600 dark:text-zinc-300 hover:text-slate-900 dark:hover:text-zinc-100 transition hidden md:inline-block">
            Products
          </Link>
          <Link href="/compare" className="text-sm font-semibold text-slate-600 dark:text-zinc-300 hover:text-slate-900 dark:hover:text-zinc-100 transition hidden md:inline-block">
            Why Review Jam
          </Link>
          <Link href="/brands" className="text-sm font-semibold text-slate-600 dark:text-zinc-300 hover:text-slate-900 dark:hover:text-zinc-100 transition hidden md:inline-block">
            For Brands
          </Link>
          <ThemeToggle />
          {user ? (
