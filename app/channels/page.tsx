...
export default function ChannelsPage() {
  ...
  const filtered = channels.filter((ch) => {
    ...
    if (search) {
      ...
      return ch.name.toLowerCase().includes(s) || ch.slug.toLowerCase().includes(s) || ch.description.toLowerCase().includes(s);
    }
    return true;
  });
      ...
      <div className="max-w-5xl mx-auto px-4 py-4">
        {loading ? (
          ...
          <div className="text-center py-16">
            <p className="text-slate-400 dark:text-slate-500 text-sm mb-2">No channels found</p>
            {user && (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[12px] text-slate-600 dark:text-slate-400 mt-0.5 line-clamp-2">{ch.description}</p>
                      </div>
                    </div>
                  </Link>
                ))}
