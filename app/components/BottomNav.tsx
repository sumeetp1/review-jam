...
export default function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 inset-x-0 z-50 bg-[#09090b]/95 backdrop-blur-md border-t border-white/[0.06] safe-area-pb">
      ...
      <div className="h-safe-area-inset-bottom bg-[#09090b]/95" />
    </nav>
  );
}
